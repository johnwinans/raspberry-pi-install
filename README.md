...
Some projects that have influenced the configuration choices made below:

- https://github.com/Z80-Retro
- https://github.com/Z80-Nouveau
...
If you are using SSH to access your PI with a public key and can log into the PI with your key then
it is now advisable to disable password-based `ssh` access to your PI so that noone
can access it over the network without a proper `ssh` key.  To do this, edit
